...
deploy-wallaby:; @forge script script/${contract}.s.sol:Deploy${contract} --rpc-url ${WALLABY_RPC_URL}  --private-key ${PRIVATE_KEY} --broadcast --verify --etherscan-api-key ${ETHERSCAN_API_KEY}  -vvvv
